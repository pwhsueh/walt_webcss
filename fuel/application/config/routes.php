...
$route['report/(:num)'] = 'orders/report/$1';
$route['do_report'] = 'orders/do_report';
$route['Saerch/(:any)'] = 'home/search/$1';
$route['register'] = 'member_about/register';
$route['do_register'] = 'member_about/do_register';
