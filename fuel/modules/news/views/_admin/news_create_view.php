			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						...
						<td>
							<div class="col-xs-5">
								<input type="text" class="form-control date input-sm" name="date" value="" required /> 
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="col-xs-5">
								<input id="title" name="title" type="text" class="form-control input-sm" value="" required/>
							</div>
						</td>
					</tr>
					<tr>
