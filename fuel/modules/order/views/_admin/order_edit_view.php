					...
					<tr>
						...
						<td>
							<div class="col-xs-5">
								...
								[<?php echo $member[0]->member_type_name ?>]
							</div>
						</td>
					</tr>
					<tr>
		...
		<h2>訂單明細</h2>
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<?php $discount=isset($member[0]->discount)?$member[0]->discount:1;  ?>
						<td><?php echo $row->pro_name ?></td>
						<td><?php echo $row->num ?></td>
						<td><?php echo $row->amount ?></td> 
						<td><?php echo $row->num * $row->amount ?></td>
						<?php $sum += $row->num * $row->amount; ?>
					</tr>
					<?php endforeach ?>
					<tr>
						<td colspan="4">
		...
		<h2>匯款回報</h2>
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						<td><?php echo $order_results->account ?></td>
						<td><?php echo $order_results->mailing_date ?></td>
						<td><?php echo $order_results->mailing_amount ?></td>
						<td><?php echo $order_results->account_nm ?></td>
					</tr>
